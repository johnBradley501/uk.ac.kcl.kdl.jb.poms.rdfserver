This is the eclipse project that is used to maintain the PoMS RDF server found at https://www.poms.ac.uk/rdf
...
dump-rdf -f TURTLE -b https://www.poms.ac.uk/rdf/entity/ -o poms_dump.ttl poms-map.ttl
...
and receive useful data back.  URIs for entities in PoMS's RDF data all begin "https://www.poms.ac.uk/rdf/entity",
with "entity" being the path component recognised by PoMS RDF Server as a request for entity data.

"https://www.poms.ac.uk/rdf/ontology" is described as a request for the PoMS ontology, and
"https://www.poms.ac.uk/rdf/endpoint" is a request to access the data-oriented SPARQL endpoint.
"https://www.poms.ac.uk/rdf/doc" is a request to access the documentation about the PoMS RDF Server.

All of rdf4j's native functionality that is supported within PoMS RDF server should begin with

"https://www.poms.ac.uk/rdf/repositories/poms"

Thus, all URLs that this tomcat application serves begin "https://www.poms.ac.uk/rdf" 
and the larger server environment needs to be set up so that URL's beginning "https://www.poms.ac.uk/rdf" 
...
uriPrefix: the prefix for all URIs that refer to PoMS's data, here: https://www.poms.ac.uk/rdf/entity/
...
https://www.poms.ac.uk/rdf/entity/Person/1, etc) and receive
