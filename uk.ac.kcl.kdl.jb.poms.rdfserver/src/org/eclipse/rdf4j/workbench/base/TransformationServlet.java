...
public abstract class TransformationServlet extends AbstractRepositoryServlet {
	/*
	 * minor change from original rdf4j code (see end of init()) to get server URL and path from SharedRepositoryHandler rather than from
	 * servlet init-parameter.    JB DDH/KCL    June 2017
	 */
		...
		throws ServletException
	{
		...
		// code added to get default-server name from SharedRepositoryHandler instead of getInitParameter    JB
		defaults.put("server", SharedRepositoryHandler.getServerURL());   // jb
		defaults.put("path", SharedRepositoryHandler.getDefaultPath());   // jb
	}
